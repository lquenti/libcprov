...
void EventRecorder::set_current_operation(const std::string& operation) {
...
/*
    DBProcessEvents& current_process() {
        return all_process_events_map_
            .try_emplace(current_pid_, DBProcessEvents{})
            .first->second;
    }*/
